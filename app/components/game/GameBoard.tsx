    ...
    <div className="relative h-screen overflow-hidden">
      <div className="flex flex-col h-full items-center gap-2 p-2">
        <div className="w-full max-w-[1600px] mx-auto h-full flex flex-col">
          ...
          {/* 桌面版布局 */}
          <div className="hidden md:grid md:grid-cols-[280px_1fr_320px] gap-2 h-[calc(100vh-80px)] md:overflow-hidden">
            {/* 左侧：贵族区域和操作历史 */}
            ...
            {/* 右侧：玩家信息 */}
            <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-2 border border-indigo-100 overflow-y-auto">
          ...
          {/* 移动设备布局 - 更改为一屏显示所有元素 */}
          <div className="md:hidden h-[calc(100vh-80px)] overflow-y-auto">
            <div className="flex flex-col gap-2">
              {/* 贵族区域 */}
              <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-2 border border-indigo-100">
                <h3 className="text-sm font-bold text-purple-800 mb-2 flex items-center">
